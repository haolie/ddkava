...
func (f *DFileModel) GetTableName() string {
	return "down_info"
}

func (f *DFileModel) GetKeys() []string {
	return []string{"Id"}
}

func NewDFileModel(id int64, fkey, compressName string, compressSize, downId int64, downUrl, vname string, link int64, status int32, updateTime, crtTime time.Time) *DFileModel {
	return &DFileModel{
		Id:           id,
		FKey:         fkey,
